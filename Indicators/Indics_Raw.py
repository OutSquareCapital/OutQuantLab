...
def calculate_mean_price_ratio_raw(prices_array: NDArrayFloat, LenST: int, LenLT: int) -> NDArrayFloat:
...
def calculate_median_price_ratio_raw(prices_array: NDArrayFloat, LenST: int, LenLT: int) -> NDArrayFloat:
...
def calculate_central_price_ratio_raw(prices_array: NDArrayFloat, LenST: int, LenLT: int) -> NDArrayFloat:
...
def calculate_mean_rate_of_change_raw(returns_array: NDArrayFloat, LenST: int, LenLT: int) -> NDArrayFloat:
...
def calculate_median_rate_of_change_raw(returns_array: NDArrayFloat, LenST: int, LenLT: int) -> NDArrayFloat:
...
def calculate_central_rate_of_change_raw(returns_array: NDArrayFloat, LenST: int, LenLT: int) -> NDArrayFloat:
...
def calculate_mean_price_macd_raw(prices_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int) -> NDArrayFloat:
...
def calculate_median_price_macd_raw(prices_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int) -> NDArrayFloat:
...
def calculate_central_price_macd_raw(prices_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int) -> NDArrayFloat:
...
def calculate_mean_rate_of_change_macd_raw(returns_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int) -> NDArrayFloat:
...
def calculate_median_rate_of_change_macd_raw(returns_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int) -> NDArrayFloat:
...
def calculate_central_rate_of_change_macd_raw(returns_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int) -> NDArrayFloat:
...
def smoothed_skewness(returns_array: NDArrayFloat, LenSmooth: int, LenSkew: int) -> NDArrayFloat:
...
def smoothed_kurtosis(returns_array: NDArrayFloat, LenSmooth: int, LenSkew: int) -> NDArrayFloat:
    smoothed_array = rolling_mean(returns_array, length=LenSmooth, min_length=LenSmooth)

    return rolling_kurtosis(smoothed_array, length=LenSkew, min_length=LenSkew)


def smoothed_directional_volatility(returns_array: NDArrayFloat, LenST: int, LenVol: int) -> NDArrayFloat:
