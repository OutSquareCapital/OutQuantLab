...
class Dashboards:
    def __init__(self, length):
        ...
        self.all_dashboards: dict[str, dict] = self.__initialize_dashboards()

    def __initialize_dashboards(self) -> dict[str, dict]:
        all_dashboards = {}
