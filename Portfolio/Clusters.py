...
def perform_clustering(distance_matrix: pd.DataFrame, num_clusters: int, method: str = 'complete') -> NDArray[np.float32]:
...
def create_cluster_dict(assets: list, clusters: NDArray[np.float32]) -> dict:
    cluster_dict = {}
