...
def curves( returns_df: DataFrameFloat,  
            title: str,
            show_legend: bool,
...
def table(
    ...
    setup_figure_layout(fig=fig, figtitle=title, show_legend=show_legend, hover_display_custom=False)
    return fig
...
def heatmap(
    ...
    setup_figure_layout(fig=fig, figtitle=title, hover_display_custom=False, show_legend=show_legend)
...
def histogram(
    ...
    setup_figure_layout(fig=fig, figtitle=title, hover_data='x', show_legend=show_legend)
    return fig
