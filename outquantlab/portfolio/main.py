...
class BacktestResults:
    def __init__(
        self, benchmark: tf.FrameVertical, global_result: tf.FrameCategorical
    ) -> None:
        ...
        self.indics: tf.FrameVertical = tf.FrameVertical.create_from_categorical(
            data=indics_by_assets_df
        )
        self.assets: tf.FrameVertical = tf.FrameVertical.create_from_categorical(
            data=assets_df
        )
