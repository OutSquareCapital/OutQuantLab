...
def mean_price_ratio(prices_array: NDArrayFloat, LenST: int, LenLT: int) -> NDArrayFloat:
...
def median_price_ratio(prices_array: NDArrayFloat, LenST: int, LenLT: int) -> NDArrayFloat:
...
def central_price_ratio(prices_array: NDArrayFloat, LenST: int, LenLT: int) -> NDArrayFloat:
...
def mean_rate_of_change(returns_array: NDArrayFloat, LenST: int, LenLT: int) -> NDArrayFloat:
    mean_roc_raw = calculate_mean_rate_of_change_raw(returns_array, LenST, LenLT)
    return sign_normalization(mean_roc_raw)

def median_rate_of_change(returns_array: NDArrayFloat, LenST: int, LenLT: int) -> NDArrayFloat:
    median_roc_raw = calculate_median_rate_of_change_raw(returns_array, LenST, LenLT)
    return sign_normalization(median_roc_raw)

def central_rate_of_change(returns_array: NDArrayFloat, LenST: int, LenLT: int) -> NDArrayFloat:
    central_roc_raw = calculate_central_rate_of_change_raw(returns_array, LenST, LenLT)
    return sign_normalization(central_roc_raw)

def mean_price_macd(prices_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int) -> NDArrayFloat:
...
def median_price_macd(prices_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int) -> NDArrayFloat:
...
def central_price_macd(prices_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int) -> NDArrayFloat:
...
def mean_rate_of_change_macd(returns_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int) -> NDArrayFloat:
...
def median_rate_of_change_macd(returns_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int) -> NDArrayFloat:
...
def central_rate_of_change_macd(returns_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int) -> NDArrayFloat:
...
def mean_price_macd_trend(prices_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int, TrendLenST: int, TrendLenLT: int) -> NDArrayFloat:
...
def median_price_macd_trend(prices_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int, TrendLenST: int, TrendLenLT: int) -> NDArrayFloat:
...
def central_price_macd_trend(prices_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int, TrendLenST: int, TrendLenLT: int) -> NDArrayFloat:
...
def mean_rate_of_change_macd_trend(returns_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int, TrendLenST: int, TrendLenLT: int) -> NDArrayFloat:
...
def median_rate_of_change_macd_trend(returns_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int, TrendLenST: int, TrendLenLT: int) -> NDArrayFloat:
...
def central_rate_of_change_macd_trend(returns_array: NDArrayFloat, LenST: int, LenLT: int, MacdLength: int, TrendLenST: int, TrendLenLT: int) -> NDArrayFloat:
...
def fixed_bias(prices_array: NDArrayFloat, Bias: int) -> NDArrayFloat:
    return np.full_like(prices_array, Bias, dtype=np.float32)

def mean_price_ratio_normalised(prices_array: NDArrayFloat, SignalLength: int, PLength: int) -> NDArrayFloat:
...
def mean_rate_of_change_normalised(returns_array: NDArrayFloat, SignalLength: int, PLength: int) -> NDArrayFloat:
...
def mean_price_ratio_normalised_trend(prices_array: NDArrayFloat, SignalLength: int, PLength: int, LenST: int, LenLT: int) -> NDArrayFloat:
...
def mean_rate_of_change_normalised_trend(returns_array: NDArrayFloat, SignalLength: int, PLength: int, LenST: int, LenLT: int) -> NDArrayFloat:
...
def skewness(returns_array: NDArrayFloat, LenSmooth: int, LenSkew: int) -> NDArrayFloat:
    skewness_array = smoothed_skewness(returns_array, LenSmooth, LenSkew)
    return sign_normalization(-skewness_array)

def relative_skewness(returns_array: NDArrayFloat, LenSmooth: int, LenSkew: int) -> NDArrayFloat:
    skewness_array = smoothed_skewness(returns_array, LenSmooth, LenSkew)
    relative_skew = relative_normalization(skewness_array, LenSkew*4)
    return sign_normalization(relative_skew)

def skewness_on_kurtosis(returns_array: NDArrayFloat, LenSmooth: int, LenSkew: int) -> NDArrayFloat:
    skewness_array = smoothed_skewness(returns_array, LenSmooth, LenSkew)
...
def relative_skewness_on_kurtosis(returns_array: NDArrayFloat, LenSmooth: int, LenSkew: int) -> NDArrayFloat:
    skewness_array = smoothed_skewness(returns_array, LenSmooth, LenSkew)
    kurtosis_array = smoothed_kurtosis(returns_array, LenSmooth, LenSkew)
...
def skewness_trend(returns_array: NDArrayFloat, LenSmooth: int, LenSkew: int, TrendLenST: int, TrendLenLT: int) -> NDArrayFloat:
...
def relative_skewness_trend(returns_array: NDArrayFloat, LenSmooth: int, LenSkew: int, TrendLenST: int, TrendLenLT: int) -> NDArrayFloat:
...
def skewness_on_kurtosis_trend(returns_array: NDArrayFloat, LenSmooth: int, LenSkew: int, TrendLenST: int, TrendLenLT: int) -> NDArrayFloat:
...
def relative_skewness_on_kurtosis_trend(returns_array: NDArrayFloat, LenSmooth: int, LenSkew: int, TrendLenST: int, TrendLenLT: int) -> NDArrayFloat:
...
def relative_directional_volatility(returns_array: NDArrayFloat, LenSmooth: int, LenRelative: int, LenVol: int) -> NDArrayFloat:
...
def normalised_directional_volatility(returns_array: NDArrayFloat, LenSmooth: int, LenNormalization: int, LenVol: int) -> NDArrayFloat:
    directional_volatility_raw = smoothed_directional_volatility(returns_array, LenSmooth, LenVol)
    return rolling_median_normalisation(-directional_volatility_raw, LenNormalization)

def relative_directional_volatility_trend(returns_array: NDArrayFloat, LenSmooth: int, LenRelative: int, LenVol: int, TrendLenST: int, TrendLenLT: int) -> NDArrayFloat:
...
def normalised_directional_volatility_trend(returns_array: NDArrayFloat, LenSmooth: int, LenNormalization: int, LenVol: int, TrendLenST: int, TrendLenLT: int) -> NDArrayFloat:
