...
def relative_directional_volatility(returns_array:np.ndarray, LenSmooth:int, LenRelative:int, LenVol: int) -> np.ndarray:
...
def normalised_directional_volatility(returns_array:np.ndarray, LenSmooth:int, LenNormalization:int, LenVol: int) -> np.ndarray:
...
def relative_directional_volatility_trend(returns_array: np.ndarray, LenSmooth:int, LenRelative:int, LenVol: int, TrendLenST: int, TrendLenLT: int) -> np.ndarray:
...
def normalised_directional_volatility_trend(returns_array: np.ndarray, LenSmooth:int, LenNormalization:int, LenVol: int, TrendLenST: int, TrendLenLT: int) -> np.ndarray:
