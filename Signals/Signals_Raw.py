...
class SeasonalityConstruction:

    @staticmethod
    def generate_seasonal_array(returns_df: pd.DataFrame) -> np.ndarray:
        ...
        # Initialisation du tableau saisonnier avec un nombre de colonnes égal aux 3 critères saisonniers
